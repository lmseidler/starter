return {
  ...
  --   -- Ensure copilot.lua is set up before avante.nvim if it's a dependency
  --   -- This is typically handled by LazyVim's dependency management,
  --   -- but explicitly calling setup here can ensure correct order if needed.
  --   -- require('copilot').setup({}) -- Only if you don't have a separate copilot.lua config
  --
